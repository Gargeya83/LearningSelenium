package com.testwithgargeya.ex05_Selenium_Waits;
...
public class TestSelenium022_Fix_Miniproject {
    ...
    public void testVwoLoginNegative(){
        ...
        WebElement passwordInputBox = driver.findElement(By.id("login-username"));
        emailInputBox.sendKeys("password@321");
