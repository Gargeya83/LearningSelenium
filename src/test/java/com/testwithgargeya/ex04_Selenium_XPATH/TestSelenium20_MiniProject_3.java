...
public class TestSelenium20_MiniProject_3 extends CommonToAll {
    @Owner("Gargeya")
    ...
    public void test_katalon_login() throws InterruptedException{
        ...
        make_appointment_btn_xpath.click(); //Click on 'Make Appointment' btn
        ...
        Assert.assertTrue(h2.isDisplayed());// Visible also
